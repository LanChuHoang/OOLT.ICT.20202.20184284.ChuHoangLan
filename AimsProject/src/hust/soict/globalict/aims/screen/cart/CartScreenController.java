...
import hust.soict.globalict.aims.exception.GetLuckyItemException;
...
public class CartScreenController {
    ...
    void getLuckyItemButtonPressed(ActionEvent event) {		
		try {
			...
			new Alert(AlertType.INFORMATION, "Congratulation, your lucky item is " + luckyItem.getTitle() + " - " + luckyItem.getCost() + " $ !").showAndWait();
			totalCostLabel.setText(cart.totalCost() + " $");
			
		} catch (GetLuckyItemException e) {
